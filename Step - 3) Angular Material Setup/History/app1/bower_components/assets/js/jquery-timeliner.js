...
;(function ( $, window, document, undefined ) {
    ...
    Timeliner.prototype = {
	    ...
	    if(!isDefault && self.items.length > 0) {
		var params = JSON.stringify(self.items);
		$.ajax({
		    type: 'POST',
		    data: params,
  		    async:false,
	    ...
	    var params = JSON.stringify(this.items);
	    $.ajax({
	    	type: 'POST',
	    	data: params,
	    	async:false,
	...
	var date_a = new Date(_a.$dk);
	var date_b = new Date(_b.$dk);
